...
module.exports = async app => {
  ...
  const {
    ...
    .then(arr => arr.reduce((prev, curr) => ({
      ...
      resolvers: R.mergeDeepWith(R.concat, prev.resolvers, curr.resolver),
      directiveResolvers: R.mergeDeepWith(R.concat, prev.directiveResolvers, curr.directiveResolver),
      schemaDirectives: R.mergeDeepWith(R.concat, prev.schemaDirectives, curr.schemaDirective),
    }), {
      typeDefs: [],
      resolvers: {},
      directiveResolvers: {},
